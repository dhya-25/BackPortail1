...
public interface Objectif_Agent_Dao extends JpaRepository<OBJECTIF_AGENT, IdObjectif_Agent> {
	@Query(value="  Select o.cod_soc ,\r\n"
			...
			+ "  o.num_objectif,\r\n"
			+ "  o.lib_objectif,\r\n"
			+ "  decode(o.appreciation,'0','non apprécié','1','Objectif partiellement atteint','2','Objectif atteint','3','Objectif dépassé')appreciation,\r\n"
			+ "  o.comment_recom \r\n"
	...
	@Query(value="delete from objectif_agent where mat_pers=:mat and num_objectif =:id and annee=:annee ",nativeQuery = true)
	
	public void  DeleteObjectif(@Param ("mat") String mat,@Param("id") Long id,@Param("annee") String annee);
}
