...
public interface ComptePersDAO extends JpaRepository<ComptePers, ComptePersID>{
	...
	public List<ComptePers> getComptePersPresidence(@Param("codSoc") String codSoc,@Param("matPers") String matPers);
	...
	@Query(value="select 	cod_soc,\r\n"
			...
			+ "from compte_pers\r\n"
			+ "where cod_soc = :codSoc and mat_pers = :matPers ",nativeQuery = true)
	public List<ComptePers> getComptePerss(@Param("codSoc") String codSoc,@Param("matPers") String matPers);
