...
public interface COMPETENCE_PERS8dAO extends JpaRepository<COMPETENCE_PERS, Id_COMPETENCE_PERS> {
	@Query(value="  Select t.cod_soc  ,\r\n"
			...
			+ "  t.val_crit_comp, \r\n"
			+ "  t.dat_valid ,\r\n"
			+ "  decode(t.appreciation,'V','Validé','E','En Instance','A','Annulé') appreciation ,\r\n"
			+ "  t.cod_niv_comp  ,\r\n"
			+ "  t.denom  ,\r\n"
			+ "   pk_get_lib.GET_NIVEAU_COM$LIB_NIV_COMP(t.cod_niv_comp) libnivcmp ,\r\n"
			+ " t.div from COMPETENCE_PERS t ,personnel l  where t.cod_soc = l.cod_soc  and t.cod_candidat = l.mat_pers   and l.mat_pers =:mat  \r\n"
			+ "",nativeQuery=true)
