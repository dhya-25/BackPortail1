...
public interface MotifJDao extends JpaRepository<Motif_j, String>{
	...
	@Query(value="select COD_M,TYP_CNG,ABRV_FIXE,LIB_MOT,ABRV_MOT,DED_SAL"
			...
			+ "SEXE,DED_TICKET,FRANCH_TICKET,COD_ALERT from MOTIF_J "
	...
	@Query(value="select COD_M,TYP_CNG,ABRV_FIXE,LIB_MOT,ABRV_MOT,DED_SAL"
			...
			+ ",NBR_JOUR_MIN,CUMUL_HSUP48,DED_ANCIENNETE,UNITE_POINT,COEF_POINT,COD_SIT,"
			+ "SEXE,DED_TICKET,FRANCH_TICKET,COD_ALERT from MOTIF_J "
			+ " where nat_cng='C' and typ_cng in ('01','02','03') and COD_M=:x " ,nativeQuery = true)
	public Motif_j getplafond(@Param("x") String x);
	...
	@Query(value="select COD_M,TYP_CNG,ABRV_FIXE,LIB_MOT,ABRV_MOT,DED_SAL"
			...
			+ ",NBR_JOUR_MIN,CUMUL_HSUP48,DED_ANCIENNETE,UNITE_POINT,COEF_POINT,COD_SIT,"
			+ "SEXE,DED_TICKET,FRANCH_TICKET,COD_ALERT from MOTIF_J "
			+ " where nat_cng='C' and typ_cng='03'",nativeQuery = true)
	public List<Motif_j> getMotifCngExeption();
