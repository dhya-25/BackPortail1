...
public class Personnel {
	...
	private String dat_ass;
	private Date dat_aff_cnam;
	private String etat_poste_trav;
	private Date dat_fin_cont;
	private String cod_fill;
	private String suspens_ass;
	private String cod_motif_susp;	
	private Date dat_fin_suspens;
	private Date dat_deb_suspens;
	...
	public Personnel(String cod_soc, String mat_pers, String nom_pers, String pren_pers, String nom_pers_a,
			...
			Date dat_niv_sal, String presum_nais, String lib_gouv, String libcaeg, String libcat, String libgrade,
			List<AdrPers2> adresses_personnel, List<PossModp> mode_payement, List<RenseignementPers> rens_pers,
			List<ETABLIS_PERS> etab, List<POSSEDE> possede, String lastsoldecng, String lib_affect2) {
		super();
	...
	public Personnel(String cod_soc, String mat_pers, String nom_pers, String pren_pers, String nom_pers_a,
			...
			Date dat_eff_fich_hand, Date dat_fin_fich_hand, Date dat_niv_sal, String presum_nais,
			List<AdrPers2> adresses_personnel, List<PossModp> mode_payement, List<RenseignementPers> rens_pers,
			List<ETABLIS_PERS> etab, List<POSSEDE> possede) {
		super();
		this.cod_soc = cod_soc;
		this.mat_pers = mat_pers;
		this.nom_pers = nom_pers;
	...
	public String getDat_ass() {
		return dat_ass;
	}

	public void setDat_ass(String dat_ass) {
	...
	public String getPers_carte() {
		return pers_carte;
	}

	public void setPers_carte(String pers_carte) {
		this.pers_carte = pers_carte;
	}
