...
public class NOTES_EVENEMENTS {
	...
	private Long  id_evenement;    
	  ...
	  @JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
	   private byte[] IMAGE_EVEN  ;
	  private String file_name_i ;
	  private String content_type_i ;
	...
	public byte[] getIMAGE_EVEN() {
		return IMAGE_EVEN;
	}
	public void setIMAGE_EVEN(byte[] iMAGE_EVEN) {
		IMAGE_EVEN = iMAGE_EVEN;
	}
	public String getFile_name_i() {
		return file_name_i;
	}
	public void setFile_name_i(String file_name_i) {
		this.file_name_i = file_name_i;
	}
	public String getContent_type_i() {
		return content_type_i;
	}
	public void setContent_type_i(String content_type_i) {
		this.content_type_i = content_type_i;
	}
	public String getPath_i() {
		return path_i;
	}
	public void setPath_i(String path_i) {
		this.path_i = path_i;
	}
	public NOTES_EVENEMENTS(Long id_evenement, String libelle, Date date_even, Date date_expiration,
			byte[] fichier_joint, String file_name, String content_type, String path, byte[] iMAGE_EVEN,
			String file_name_i, String content_type_i, String path_i, String typ_droit, String typ_even) {
		super();
		this.id_evenement = id_evenement;
		this.libelle = libelle;
		this.date_even = date_even;
