...
private String lib_autorisation;
	...
	public Libre_demande(Long idlibredemande, String codSoc, String matPers, String typDemande, Date dateDemande,
		...
		String codAut, String nat_cng, Long annee, String motif, String state, String npren_pers, String lib_demande,
		String titre, String type_formation, String theme, String group_pret, String lib_pret,
		String lib_autorisation) {
	super();
	this.idlibredemande = idlibredemande;
	this.codSoc = codSoc;
...
public void setState(String state) {
	...
	public Long getIdlibredemande() {
		return idlibredemande;
	}
	public void setIdlibredemande(Long idlibredemande) {
		this.idlibredemande = idlibredemande;
	}
