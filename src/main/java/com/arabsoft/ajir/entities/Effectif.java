...
public class Effectif {
	...
	public Effectif(String aNNEE, String lIB_CAT, String lIB_GRAD, String lIB_SERV, String sEXE, String c,
	...
	public String toString() {
		return "Effectif {ANNEE=" + ANNEE + ", LIB_CAT=" + LIB_CAT + ", LIB_GRAD=" + LIB_GRAD + ", LIB_SERV=" + LIB_SERV
				+ ", SEXE=" + SEXE +  ", c=" + c + ", TAUX_TURN_OVER=" + TAUX_TURN_OVER + ", TAUX_EMBAUCHE="
				+ TAUX_EMBAUCHE + "}";
	}
