...
public class AbsanteismeController {
	...
	@CrossOrigin
	@GetMapping("/AbsanteismeByLibellebycodandmat/{cod}/{mat}")
	public List<AbsanteismeByLibelle> GetAbsanteismeByLibellebycodandmat(@PathVariable("cod") String cod,@PathVariable("mat") String mat){
		return this.absanteismeByLibelleDAO.GetAbsanteismeByLibellebycodsocandmatpers(cod,mat);
